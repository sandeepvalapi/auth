...
import ex.ms.auth.dto.validation.SupportedAuthorities;
...
import lombok.Value;
import ex.ms.auth.dto.validation.SupportedGrantTypes;
...
import static ex.ms.auth.dto.PasswordRestrictions.ERROR_MESSAGE_PASSWORD;
import static ex.ms.auth.dto.PasswordRestrictions.REGEX_ENFORCER;
